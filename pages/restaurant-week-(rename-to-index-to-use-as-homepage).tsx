...
import UberEatsLinks from "../components/page-uber";
...
export default function Index({
  homeData: { title, id, content, uberEatsWeekFields, homepageFields, pageFields, advertisements },
  mainMenu,
  footerMenu,
  socialMenu,
  preview,
  ...
  console.log( uberEatsFeaturedLinks );
  ...
  return (
    ...
    >
      ...
      <Main>
        ...
        <PageSeparator optionalHeadline="features" />
        <PageAd adData={midAd} />
        <UberEatsLinks relatedPages={ uberEatsFeaturedLinks } />
...
export const getStaticProps: GetStaticProps = async ({ preview = false }) => {
  const homeData = await getUberPageData(preview);
  return {
    props: {
